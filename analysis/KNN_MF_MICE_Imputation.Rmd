...
for (s in 1:sim_number){
  ...
  if (type == "regression"){
    ...
    impute_knn <- select(impute_set, -c(response))
    knn_test <- select(test_set, - c(response))
...
for (s in 1:sim_number){
  ...
  for (m_5 in 1:num_impute){
    ...
    impute_knn <- select(impute_list[[m_5]], -c(response))
    knn_test <- select(test_set, -c(response))
...
class_hyper_1 <- list(mtry = 2, rf_trees = 400, depth_gbm = 2, gbm_trees = 500, 
            kernel = "radial", gamma = 1, cost = 20, k_neighbor = 3)
...
test_MICE_2 <- MICE_Impute_Testing(data = diabetes_final, form_train =class ~.,
...
KNN_test_1 <-  KNN_MF_Simple_Impute_Testing(method = "Simple", data = diabetes_final, form_train = class ~., response = "class", type = "Classification", sim_number = 10,
                               training_split = 0.8, K = 5, mf_tree = 100, percentLeft = 0.95, 
                               transformation = FALSE, transformation_function = NULL, 
                               class_hyper = class_hyper_1, reg_hyper = NULL)
  

KNN_test_2 <-  KNN_MF_Simple_Impute_Testing(method = "KNN", data = diabetes_final, form_train = class ~., response = "class", type = "Classification", sim_number = 10,
                               training_split = 0.8, K = 5, mf_tree = 100, percentLeft = 0.95, 
                               transformation = FALSE, transformation_function = NULL, 
                               class_hyper = class_hyper_1, reg_hyper = NULL)


KNN_test_3 <-  KNN_MF_Simple_Impute_Testing(method = "MissForest", data = diabetes_final, form_train = class ~., response = "class", type = "Classification", sim_number = 10,
                               training_split = 0.8, K = 5, mf_tree = 100, percentLeft = 0.95, 
                               transformation = FALSE, transformation_function = NULL, 
                               class_hyper = class_hyper_1, reg_hyper = NULL)


test_MICE_3 <- MICE_Impute_Testing(data = diabetes_final, form_train =class ~.,
                                response = "class", type = "classification", sim_number = 10,
                               training_split = 0.8, num_impute = 5, maxiter = 10, percentLeft = 0.95, 
                               transformation = FALSE, transformation_function = NULL, 
                               class_hyper = class_hyper_1)
...
class_hyper_1 <- list(mtry = 12, rf_trees = 196, depth_gbm = 2, gbm_trees = 4912, 
            kernel = "linear", gamma = 1, cost = 1, k_neighbor = 12)
```

```{r}
test_simple_1 <- KNN_MF_Simple_Impute_Testing(method = "Simple", data = new_dummy_steelplates, form_train = Class ~.,
                                 response = "Class", type = "classification", sim_number = 100,
                               training_split = 0.8, K = 5, mf_tree = 100, percentLeft = 0.99, 
                               transformation = FALSE, transformation_function = NULL, 
                               class_hyper = class_hyper_1)

test_simple_2 <- KNN_MF_Simple_Impute_Testing(method = "Simple", data = new_dummy_steelplates, form_train = Class ~.,
                                 response = "Class", type = "classification", sim_number = 100,
                               training_split = 0.8, K = 5, mf_tree = 100, percentLeft = 0.95, 
                               transformation = FALSE, transformation_function = NULL, 
                               class_hyper = class_hyper_1)

test_simple_3 <- KNN_MF_Simple_Impute_Testing(method = "Simple", data = new_dummy_steelplates, form_train = Class ~.,
                                 response = "Class", type = "classification", sim_number = 100,
                               training_split = 0.8, K = 5, mf_tree = 100, percentLeft = 0.90, 
                               transformation = FALSE, transformation_function = NULL, 
                               class_hyper = class_hyper_1)

write.csv(1 - test_simple_1, "SteelPlate_Simple_99")
write.csv(1 - test_simple_2, "SteelPlate_Simple_95")
write.csv(1 - test_simple_3, "SteelPlate_Simple_90")
```

```{r}
test_mf_1 <- KNN_MF_Simple_Impute_Testing(method = "MissForest", data = new_dummy_steelplates, form_train = Class ~.,
                                 response = "Class", type = "classification", sim_number = 100,
                               training_split = 0.8, K = 5, mf_tree = 100, percentLeft = 0.99, 
                               transformation = FALSE, transformation_function = NULL, 
                               class_hyper = class_hyper_1)

test_mf_2 <- KNN_MF_Simple_Impute_Testing(method = "MissForest", data = new_dummy_steelplates, form_train = Class ~.,
                                 response = "Class", type = "classification", sim_number = 100,
                               training_split = 0.8, K = 5, mf_tree = 100, percentLeft = 0.95, 
                               transformation = FALSE, transformation_function = NULL, 
                               class_hyper = class_hyper_1)

test_mf_3 <- KNN_MF_Simple_Impute_Testing(method = "MissForest", data = new_dummy_steelplates, form_train = Class ~.,
                                 response = "Class", type = "classification", sim_number = 100,
                               training_split = 0.8, K = 5, mf_tree = 100, percentLeft = 0.90, 
                               transformation = FALSE, transformation_function = NULL, 
                               class_hyper = class_hyper_1)

write.csv(1 - test_mf_1, "SteelPlate_MF_99")
write.csv(1 - test_mf_2, "SteelPlate_MF_95")
write.csv(1 - test_mf_3, "SteelPlate_MF_90")
```

```{r}
test_knn_1 <- KNN_MF_Simple_Impute_Testing(method = "KNN", data = new_dummy_steelplates, form_train = Class ~.,
                                 response = "Class", type = "classification", sim_number = 100,
                               training_split = 0.8, K = 12, mf_tree = 100, percentLeft = 0.99, 
                               transformation = FALSE, transformation_function = NULL, 
                               class_hyper = class_hyper_1)

test_knn_2 <- KNN_MF_Simple_Impute_Testing(method = "KNN", data = new_dummy_steelplates, form_train = Class ~.,
                                 response = "Class", type = "classification", sim_number = 100,
                               training_split = 0.8, K = 12, mf_tree = 100, percentLeft = 0.95, 
                               transformation = FALSE, transformation_function = NULL, 
                               class_hyper = class_hyper_1)

test_knn_3 <- KNN_MF_Simple_Impute_Testing(method = "KNN", data = new_dummy_steelplates, form_train = Class ~.,
                                 response = "Class", type = "classification", sim_number = 100,
                               training_split = 0.8, K = 12, mf_tree = 100, percentLeft = 0.90, 
                               transformation = FALSE, transformation_function = NULL, 
                               class_hyper = class_hyper_1)

write.csv(1 - test_knn_1, "SteelPlate_KNN_99")
write.csv(1 - test_knn_2, "SteelPlate_KNN_95")
write.csv(1 - test_knn_3, "SteelPlate_KNN_90")
```

```{r}
test_MICE_1 <- MICE_Impute_Testing(data = new_dummy_steelplates, form_train = Class ~.,
                                response = "Class", type = "classification", sim_number = 100,
...
test_MICE_3 <- MICE_Impute_Testing(data = new_dummy_steelplates, form_train = Class ~.,
                                response = "Class", type = "classification", sim_number = 100,
                               training_split = 0.8, num_impute = 5, maxiter = 10, percentLeft = 0.90, 
                               transformation = FALSE, transformation_function = NULL, 
                               class_hyper = class_hyper_1)

write.csv(1 - test_MICE_1, "SteelPlate_Mice_99")
write.csv(1 - test_MICE_2, "SteelPlate_Mice_95")
write.csv(1 - test_MICE_3, "SteelPlate_Mice_90")
```
