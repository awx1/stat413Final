...
```{r, warning = FALSE}
KNN_MF_Impute_Testing <- function(method, data, form_train, response, type, sim_number = 250,
...
KNN_test_2 <-  KNN_MF_Impute_Testing(method = "MissForest", data = diabetes_final, form_train = class ~., response = "class", type = "Classification", sim_number = 10,
                               training_split = 0.8, K = 5, mf_tree = 100, percentLeft = 0.95, 
                               transformation = FALSE, transformation_function = NULL, 
