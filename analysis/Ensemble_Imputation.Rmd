...
```{r}
Ensmble_Imputation_Testing <- function(data, form_train, response, type, sim_number = 250,
...
```{r}
Ensmble_Imputation_Testing(data = final_wage, form_train = logwage ~., response = "logwage", type = "regression", sim_number = 5,  training_split = 0.8, knn_vec = c(3, 5), mf_tree_vec = c(100, 150), 
                               num_impute = 5, maxiter = 10, percentLeft = 0.95, 
